...
def almostEgalPoint(a,b,tolerance):
...
def isSquare(p1, p2, p3, p4,points):
    ...
    print(p1p2,p3p4)
    #inf 10^2, sup 30^2
    if almostEgalDistance(p1p2,p3p4) and p1p2 > 200 and p1p2 < 800:
        
        p1p4 = distanceSquare(p1, p4)
        p2p3 = distanceSquare(p2, p3)
        print(p1p4,p2p3)
        if almostEgalDistance(p1p4,p2p3) and p1p4 > 200 and p1p4 < 800:
            #return True
            ...
            if p2p4 > 3*p1p3/4 and p2p4 < p1p3*1.25:
                m14 = middlePoint(p1,p4)
                bm14 = True
                m23 = middlePoint(p2,p3)
                bm23 = True
                m12 = middlePoint(p1,p2)
                bm12 = True
                m34 = middlePoint(p3,p4)
                bm34 = True
                for point in points:
                    if bm14 and almostEgalPoint(m14,point,1):
                        bm14 = False
                    if bm23 and almostEgalPoint(m23,point,1):
                        bm23 = False
                    if bm12 and almostEgalPoint(m12,point,1):
                        bm12 = False
                    if bm34 and almostEgalPoint(m34,point,1):
                        bm34 = False
                    if not (bm14 and bm23 and bm12 and bm34):
                        m1m14 = middlePoint(p1,m14)
                        m4m14 = middlePoint(p4,m14)
                        m1m12 = middlePoint(p1,m12)
                        m2m12 = middlePoint(p2,m12)
                        m2m23 = middlePoint(p2,m23)
                        m3m23 = middlePoint(p3,m23)
                        m3m34 = middlePoint(p3,m34)
                        m4m34 = middlePoint(p4,m34)
                        ...
                        for point in points:
                            if bm1m14 and almostEgalPoint(m1m14,point,1):
                                bm1m14 = False
                            if bm4m14 and almostEgalPoint(m4m14,point,1):
                                bm4m14 = False
                            if bm1m12 and almostEgalPoint(m1m12,point,1):
                                bm1m12 = False
                            if bm2m12 and almostEgalPoint(m2m12,point,1):
                                bm2m12 = False
                            if bm2m23 and almostEgalPoint(m2m23,point,1):
                                bm2m23 = False
                            if bm3m23 and almostEgalPoint(m3m23,point,1):
                                bm3m23 = False
                            if bm3m34 and almostEgalPoint(m3m34,point,1):
                                bm3m34 = False
                            if bm4m34 and almostEgalPoint(m4m34,point,1):
                                bm4m34 = False
                            if not(bm1m14 and bm4m14 and bm1m12 and bm2m12 and bm2m23 and bm3m23 and bm3m34 and bm4m34):
                                return True
            ...
            for i in coords:
                ...
                for j in coords:
                    ...
                    for k in coords:
                        ...
                        if not almostEgalPoint(i,j,3) and not almostEgalPoint(j,k,3) and not almostEgalPoint(k,x_max,3) and not almostEgalPoint(x_max,i,3): #if there are almost egal
                            ...
                            if isSquare(i,j,k,x_max,coords): #if is square
                                ...
                                try:
                                    #print(results[-1])
                                    #print(O)
                                    if not almostEgalPoint(results[-1],O,3):
                                        results.append(O)
                                except IndexError:
                                    #pass
                                    results.append(O)
...
if __name__ == '__main__':
    ...
    print(true/len(L))
        ...
        #print('')
    '''
    print(squareFinding("captcha/3.txt"))
