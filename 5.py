...
def isSquare(p1, p2, p3, p4):
    ...
    #inf 10^2, sup 30^2
    if almostEgalDistance(p1p2,p3p4) and p1p2 > 70 and p1p2 < 500:
        
        p1p4 = distanceSquare(p1, p4)
        p2p3 = distanceSquare(p2, p3)
        
        if almostEgalDistance(p1p4,p2p3) and p1p4 > 70 and p1p4 < 500:
                ...
                for j in coords:
                    ...
                    for k in coords:
                        ...
                        if not almostEgalPoint(i,j) and not almostEgalPoint(j,k) and not almostEgalPoint(k,x_max) and not almostEgalPoint(x_max,i): #if there are almost egal
                            ...
                            if isSquare(i,j,k,x_max): #if is square
